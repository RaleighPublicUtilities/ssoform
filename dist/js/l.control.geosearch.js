    ...
    _showLocation: function (location) {
        if (this.options.showMarker == true) {
            if (typeof this._positionMarker === 'undefined')
                this._positionMarker = L.marker([location.Y, location.X], {icon: myIcon, riseOnHover: true}).addTo(this._map);
            else
                this._positionMarker.setLatLng([location.Y, location.X], {icon: myIcon, riseOnHover: true});
        }
