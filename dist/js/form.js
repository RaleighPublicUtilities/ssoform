        ...
        $.getJSON(url , function( data ) {
          ...
          for(each in data.fields){
            ...
            var formControls = {
              ...
              "esriFieldTypeDate": '<div id="'+field+'div" class="form-group"><label for="'+ field + '">'+ alias +'<i class="text-danger"> (Required)</i></label><input type="date" class="form-control" id="'+ field +'" value="' + getCurrentDate() + '"></div>',
