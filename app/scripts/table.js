...
function createTable(info){
  ...
  datatable.onAdd = function (map) {
    var table = L.DomUtil.create('div', 'info table');
      table.innerHTML = '<div id="tableborder" class="container"><div class="col-md-12"><button type="button" class="btn btn-danger btn-sm" style="margin-left: 50em; margin-bottom: -50px;" onclick="removeTable();">Close</button><table id="datatable" class="table table-hover"></table></div></div>';
